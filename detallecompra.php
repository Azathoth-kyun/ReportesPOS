<?php 
  ...
  if(isset($_GET['idcompra'])){
    ...
    $select_query = "SELECT P.descripcion as descripcion, PL.cantidad as cantidad, UM.unidad as unidad , FORMAT(DC.preciocompraunitario,2) as precio FROM detalle_compra DC INNER JOIN producto_lote PL ON DC.idproducto_lote = PL.idproducto_lote INNER JOIN producto P ON PL.idproducto = P.idproducto INNER JOIN unidad_medida UM ON P.idunidad_medida = UM.idunidadmedida WHERE DC.numero_comprobante = '$idcompra' ;";
...
<html lang="en">
  <head>
  	<title>Detalle Compras - Reportes Libertad</title>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h1 class="mb-4 text-center">Detalle de Compra: <?php echo $idcompra ?></h1>
        <hr />
      ...
      <!-- Fin de Tabla -->
        ...
        <div class="text-center mt-5">
          <a role="button" href="reportecompra.php" class="btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;Volver a Reportes</a>
        </div>
